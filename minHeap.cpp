...
int main(){
    minHeap h;
    Student s(20210205,"abdelrhman", "CS", 3.5);
    Student s1(20210235,"gamal", "IT", 3.9);
    ...
    Student s6(20210305,"hisham", "CS", 3.5223);
    Student s7(20210305,"adel", "CS", 3.5223);
    Student s8(20210305,"ahmed", "CS", 3.5223);
    h.push(s);
    h.push(s1);
    h.push(s2);
    h.push(s3);
